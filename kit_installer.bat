...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/Ludo-Game-with-Sam/releases/download/v1.0.0/Ludo-Game.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/Ludo-Game-with-Sam/raw/main/requirements.txt
